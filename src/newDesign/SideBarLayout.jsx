  ...
  return (
    <aside className="h-96 sm:w-full sm:h-full overflow-hidden relative" aria-label="Sidebar">
      <div className="sm:max-h-fit w-full  py-4 px-3 bg-gray-50  dark:bg-gray-800">
        ...
        <div className="overflow-y-auto scroll-smooth h-screen w-full sm:max-w-sm mx-auto relative  bg-white dark:bg-slate-800 dark:highlight-white/5 shadow-lg ring-1 ring-black/5 rounded-xl flex flex-col divide-y dark:divide-slate-200/5">
